...
private FragmentManager fragmentManager;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		fragmentTransaction.replace(R.id.t2_nskz_container,fragment1);//将fragment1设置到布局上
		fragmentTransaction.commit();
				
		//左上返回键
		LinearLayout lv_up = (LinearLayout)findViewById(R.id.t2_nskz_up);
		...
		//查看课程
		Button bt1 = (Button)findViewById(R.id.t2_nskz_bt1);
