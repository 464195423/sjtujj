...
//				JSONObject jsonObject = (JSONObject) JSONObject.parse(json);
		...
		}, MyPath.ddxx_path, map, DB.getSessionid(T2_yjddActivity.this));
	}
...
//				JSONObject jsonObject = (JSONObject) JSONObject.parse(json);
		...
		}, MyPath.removeOrder_path, map, DB.getSessionid(T2_yjddActivity.this));		
	}
