...
import com.yousi.net.T2_t7_getTeachHours_net;
import com.yousi.sjtujj.R;
import com.yousi.sjtujj.T2_ddxxActivity;
import com.yousi.sjtujj.T2_skjlActivity;
import com.yousi.sjtujj.T2_skjsActivity;
...
private T2_t7_getTeachHours_net T2_t7_getTeachHours_netItems;
	...
	protected void onCreate(Bundle savedInstanceState) {
        ...
        //右上授课记录
        LinearLayout lv_up_right = (LinearLayout)findViewById(R.id.t2_ksz_up_right);
        lv_up_right.setOnClickListener(new View.OnClickListener() {
			
			@Override
			public void onClick(View v) {
				// TODO Auto-generated method stub
				Intent intent = new Intent(T2_skzActivity.this, T2_skjlActivity.class);
...
//				JSONObject jsonObject = (JSONObject) JSONObject.parse(json);
		...
		}, MyPath.T3_getTeachHours, map, DB.getSessionid(T2_skzActivity.this));
	}	
...
//				JSONObject jsonObject = (JSONObject) JSONObject.parse(json);
		...
		}, MyPath.quxiaoshouke_path, map, DB.getSessionid(T2_skzActivity.this));		
